...
namespace Restaurant_DB
{
    public partial class Manager : Form
    {
        ...
        {
            int result = controllerobj.UpdateEmployee(Convert.ToInt16(MANAGER_SSN.Text), FName_Man.Text,LName_Man.Text,"Manager",Convert.ToInt16( Working_Hours_Man.Text),Convert.ToDecimal(Salary_Man.Text),City_Man.Text,Street_Man.Text,Building_Man.Text,EPass_Man.Text);
       ...
       private  void Salary_Man_KeyPress(object sender, KeyPressEventArgs e)
        ...
        private void Working_Hours_Man_KeyPress(object sender, KeyPressEventArgs e)
        {
                ...
                if (e.KeyChar == '.' && Working_Hours_Man.Text.Contains("."))
                {
